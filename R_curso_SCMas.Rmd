...
dat<-read_csv("D:/BoxFiles/Box Sync/github/Intro_R_espacial_2/data/canidae_records.csv")
```
...
localidades<-read_csv("D:/BoxFiles/Box Sync/github/Intro_R_espacial_2/data/canidae_localidades.csv")
```


```{r eval=FALSE, include=TRUE}
localidades<-read_csv("canidae_localidades.csv") #ajustar si re requiere
```
...
Para ello, podemos utilizar la función `distinct()`, la cual selecciona distintas entradas:
...
dat_mamm<-read.csv("D:/BoxFiles/Box Sync/github/Intro_R_espacial_2/data/mamiferos_COL_GBIF.csv")
```
